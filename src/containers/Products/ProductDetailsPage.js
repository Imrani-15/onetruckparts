...
class ProductDetailsPage extends React.Component {
    ...
    render() {
        const { selectedQuantity, quantities, productDetails, productImages,
            showLoader, cartLoader, toastMsg, productFitmentList } = this.state;
                    ...
                    {!showLoader ?
                        <Row className="prod-details-submain">
                            ...
                            <Col xs={24} sm={24} md={24} lg={9} className="p-p-4">
                                <h1 style={{ color: appTheme.secondaryColor, fontWeight: 'bold', lineHeight: 1.4 }} >{productDetails.title}</h1>
                            ...
                            <Col xs={24} sm={24} md={12} lg={5} className="p-mt-4" >
                                <div className="p-shadow-2 p-p-3  p-mb-3">
                                    <h2>Price: ${parseFloat(productDetails.usd_retailprice).toFixed(2)}</h2>
